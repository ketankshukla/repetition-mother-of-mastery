  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        {/* Series Title Block — matching book cover typography */}
        <div className="mb-4">
          <p className="font-serif text-sm tracking-[0.4em] uppercase text-gold/80 sm:text-base">
            The Repetition Series
          </p>
        </div>

        <h1 className="mb-2 font-serif font-bold tracking-tight">
          <span className="block text-5xl sm:text-7xl lg:text-8xl text-cream">
            Repetition
          </span>
        </h1>
        ...
        <h2 className="mb-6 font-serif text-lg tracking-[0.25em] uppercase text-gold sm:text-xl lg:text-2xl italic font-normal">
          Mother of Mastery
        </h2>
        ...
        >
          <div className="relative overflow-hidden rounded-2xl border border-gold/30 shadow-gold-lg aspect-[2/3]">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-4 sm:p-6">
              <p className="font-serif text-xs tracking-[0.3em] uppercase text-gold sm:text-sm">
                Book {books[currentSlide].roman}
              </p>
              <p className="font-serif text-lg font-bold text-cream sm:text-xl">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-2 top-1/2 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full bg-black/50 text-gold/80 backdrop-blur-sm transition hover:bg-black/70 hover:text-gold sm:h-10 sm:w-10"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-2 top-1/2 -translate-y-1/2 flex h-9 w-9 items-center justify-center rounded-full bg-black/50 text-gold/80 backdrop-blur-sm transition hover:bg-black/70 hover:text-gold sm:h-10 sm:w-10"
